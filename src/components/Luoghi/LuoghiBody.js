...
function LuoghiBody({ rows, car }) {
    ...
    let day = 0;
    return (
        <div className="container-fluid card-body" style={{ borderTop: '1px solid lightgray' }}>
            {
                rows.map((row, index) => {
                    day++;
                    let arrImg = [];
                    return (
                        <div className='row'>
                            <div className="col-xl-12 d-flex justify-content-center">
                                <Timeline day={day} car={car} index={index} className='col-xl-2' />
                                <div className="col-xl-10 col-lg-10 col-sm-12 col-xs-12" key={row.id}>
